<template>
  ...
  <div v-if="!TypeData || TypeData.length === 0"
    ...
    <h3 class="text-lg md:text-2xl lg:text-3xl font-bold text-gray-700 mb-3">ไม่มีประเภท</h3>
    <p class="text-gray-500 text-md md:text-lg lg:text-xl">เริ่มต้นด้วยการเพิ่มประเภทใหม่</p>

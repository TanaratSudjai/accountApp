<template>
  <BackComponents />
  <div class="bg-white rounded-sm border border-gray-200 overflow-hidden mb-20 p-3">
      ...
      <table v-if="page == 'report'" class="w-full border-collapse">
        ...
        <thead>
          <tr class="">
            ...
            <th class="px-6 py-4 text-sm font-semibold text-gray-900 border-b text-center">
              1
            </th>
            <th class="px-6 py-4 text-sm font-semibold text-gray-900 border-b text-center">
              2
        ...
        <tbody>
          <tr v-for="(row, index) in filteredReport" :key="row.label" :class="[
            ...
            <!-- เดือนที่ 1 ถึง 12 -->
            <td v-for="month in 12" :key="month" class="px-6 py-4 border-r text-right">

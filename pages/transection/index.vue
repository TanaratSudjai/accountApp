<template>
  <div class="mx-auto max-w-4xl rounded-lg min-h-screen">
    <div class="flex flex-col min-h-screen w-full">
      ...
      <!-- Transactions List -->
      <div class="bg-gray-800 min-h-[200px] rounded-xl shadow-md overflow-hidden mb-2">
        <div class="text-center p-2 font-medium text-green-400">รายการธุรกรรมการเปิดบัญชี</div>

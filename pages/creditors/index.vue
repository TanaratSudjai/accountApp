    ...
    <div class="flex justify-center w-full p-4 mb-6">
      <div class="w-full flex justify-center max-w-4xl space-y-2">
        <div class="relative w-full max-w-2xl">
          <div class="flex border border-gray-300 rounded-lg overflow-hidden relative ">
            <!-- Background Slider -->
            <div
            ...
            <button
              ...
              :class="activeButton === 'borrow' ? 'text-gray-800' : 'text-gray-600'"
            >
              ยืม
            </button>
            <button
              @click="setActive('return')"
              class="relative z-10 flex-1 px-4 py-2 text-center transition-colors duration-300"
              :class="activeButton === 'return' ? 'text-gray-800' : 'text-gray-600'"
            >
              คืน
            </button>
          </div>

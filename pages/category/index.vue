<template>
  ...
  <div class="flex-1 p-6">
    <div class="grid grid-cols-2 md:grid-cols-2 gap-2 max-w-4xl mx-auto">
      
        <NuxtLink
          v-for="(item, index) in menuItems"
          :key="index"
          :to="item.route"
          class="bg-white rounded-lg shadow-md p-6 flex flex-col items-center justify-center transition-shadow truncate h-[180px] hover:shadow-lg"
        >

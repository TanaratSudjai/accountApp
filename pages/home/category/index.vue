...
const menuItems = ref([
  {
    ...
    title: "สินทรัพย์",
    color: "text-sky-900",
    route: `/home/category/group?id=1`, // Replace with the appropriate account_category_id
  },
  {
    icon: Landmark,
    title: "ธนาคาร",
    color: "text-sky-900",
    route: "/home/category/group?id=7",
  },
  {
    icon: Users,
    title: "ลูกหนี้",
    color: "text-sky-900",
    route: "/home/category/group?id=6",
  },
  {
    icon: Grid2x2Plus,
    title: "หนี้สิน",
    color: "text-sky-900",
    route: "/home/category/group?id=2",
  },
  {
    icon: HandCoins,
    title: "รายได้",
    color: "text-sky-900",
    route: "/home/category/group?id=4",
  },
  {
    icon: CircleDollarSign,
    title: "ค่าใช้จ่าย",
    color: "text-sky-900",
    route: "/home/category/group?id=5",
  },

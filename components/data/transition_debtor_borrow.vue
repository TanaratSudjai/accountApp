      ...
      <div class="p-3">
        ...
        <div class="bg-white overflow-hidden">
          <div class="py-4  border-b border-gray-200 flex items-center justify-between">
            <span class="font-medium text-xs md:text-sm lg:text-md text-gray-800 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <span class="bg-blue-100 text-blue-700 text-xs md:text-sm lg:text-md  font-medium px-2.5 py-1 rounded-full">

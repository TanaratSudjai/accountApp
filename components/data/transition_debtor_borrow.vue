      ...
      <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-7 gap-6 mb-8">
          <div class="md:col-span-3 space-y-3">
            ...
            >
              <span
                class="inline-flex items-center justify-center bg-green-100 rounded-full mr-2 text-green-600 text-sm"
                >1</span
              >
            ...
            <div class="space-y-3">
              ...
              >
                <button
                  :class="[
                    'w-full transition-all duration-200 border rounded-xl overflow-hidden  hover:shadow focus:outline-none',
                    columnOneSelected &&
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            <div class="relative flex-1">
              ...
              <input
                ...
                class="w-full pl-10 pr-4 py-3 text-gray-800 bg-white border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                v-model="accountTypeValue"
              />
            </div>
            <button
              :class="[
                'py-3 px-6 rounded-md font-medium text-white transition-all duration-200 flex items-center justify-center min-w-32',
                isButtonDisabled

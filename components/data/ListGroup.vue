<template>
  ...
  <HooksUpdateGroupModal :show="showUpdateModal" :accountGroup="selectedAccountGroup" @update="handleUpdate"
...
const goToPath = (account_group_id, categoryID) => {
  router.push(`/home/category/group/type/${account_group_id}?category_id=${categoryID}`);
};
</script>

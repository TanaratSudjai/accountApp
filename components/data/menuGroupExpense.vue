          ...
          <div class="px-8 py-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-4">
                <div
                  class="w-2 h-8 bg-gradient-to-b from-red-500 to-rose-600 rounded-full"
                ></div>
                <div>
              ...
              <div class="flex items-center space-x-2">
                <span
                  class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-red-100 to-rose-100 text-red-800 border border-green-200"
                >
                  <svg
                    class="w-4 h-4 mr-2"
                    fill="none"
                  ...
                  >
                    ...
                    <div class="relative flex items-center justify-between">
                      ...
                      <div class="text-right space-y-2">
                        <div
                          class="text-2xl font-bold text-gray-800 group-hover:text-red-700 transition-colors duration-300"
                        >

      ...
      <div v-else class="space-y-8">
        ...
        <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
          <div class="flex flex-col items-center text-center space-y-4">
            ...
            <div class="relative">
              <div class="absolute inset-0 bg-gradient-to-br from-red-200/30 rounded-2xl blur-xl opacity-30 animate-pulse"></div>
              <div class="relative bg-gradient-to-br from-red-300 to-red-600 p-4 rounded-2xl shadow-lg">

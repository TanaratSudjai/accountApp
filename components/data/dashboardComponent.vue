  ...
  <div class="flex flex-col max-w-4xl mx-auto space-y-4 rounded-lg">
    ...
    <div v-else>
      ...
      <table class="w-full text-center">
        ...
        <tbody>
          <tr v-for="(transitions, index) in transition_data" :key="index"
            ...
            <td class="p-3">
              ...
              <div v-else class="bg-green-100 rounded-full p-3 w-full flex justify-center">
                {{ transitions.account_type_total }}
            ...
            <td>
              ...
              <div id="modal-s" popover>
                <div class="bg-white shadow-lg p-8 w-[300px] rounded-md h-auto flex flex-col gap-6">
                  <button @click="banklocation()"
                    class="p-4 bg-white border-l-yellow-500 border-4 rounded-lg shadow-lg">
                    ธนาคาร
                  </button>
                  <button @click="incomelocation()"
                    class="p-4 bg-white border-l-green-500 border-4 rounded-lg shadow-lg">
                    รายได้
                  </button>
                  <button @click="expenselocation()"

  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-8 px-4">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center mb-12">
        ...
        <div class="w-24 h-1.5 bg-gradient-to-r from-indigo-600 to-purple-600 mx-auto rounded-full mb-4"></div>
                  ...
                  <div class="flex items-center space-x-4">
                    <div class="flex-shrink-0">
                      <div 
                        ...
                        :class="transition.account_category_id === 4 ? 'bg-gradient-to-r from-green-400 to-green-600' : 'bg-gradient-to-r from-red-400 to-red-600'"
                      ></div>
                    </div>
                    <div class="flex-1 min-w-0">
                      <p class="text-base font-semibold text-gray-900 group-hover:text-indigo-700 transition-colors duration-300">
                  ...
                  >
                    <div 
                      :class="[
                        ...
                        parseFloat(transition.account_type_total) < parseFloat(transition.account_type_sum) 
                    ...
                    >
                      <div class="flex items-center space-x-2">
                        <svg 
                          :class="parseFloat(transition.account_type_total) < parseFloat(transition.account_type_sum) ? 'text-red-500' : 'text-green-500'"
                          class="w-4 h-4" 
                          fill="none" 
                          stroke="currentColor" 
                          viewBox="0 0 24 24"
                        >
                          <path 
                            ...
                            stroke-width="2" 
                            :d="parseFloat(transition.account_type_total) < parseFloat(transition.account_type_sum) 
                              ? 'M19 14l-7 7m0 0l-7-7m7 7V3' 
                              : 'M5 10l7-7m0 0l7 7m-7-7v18'"
                          ></path>
                        </svg>
                        <span>{{ Math.abs(transition.account_type_difference)  }}</span>
                      </div>
                    </div>
                  </div>

      ...
      <div class="w-full max-w-4xl space-y-2">
        <div class="grid grid-cols-7 gap-4">
          ...
          <div class="flex flex-col col-span-3">
            <div v-for="item in catData" :key="item.account_type_id" class="mb-2">
              ...
              <button v-else :class="[
                ...
                <div class="border border-gray-300 rounded-lg p-4 flex items-center justify-center h-full py-7">
                  <p class="font-medium text-lg truncate">
          ...
          <div class="flex flex-col col-span-3">
            <div v-for="item in creditor" :key="item.account_type_id" class="mb-2">
              <button v-if="
        ...
        <div class="flex border-2 border-gray-300 rounded-xl p-2 gap-2 justify-center bg-white shadow-md">
          <input type="number" placeholder="ตั้งจำนวนเงิน"
        ...
        <div class="bg-white rounded-lg shadow-md p-4">
          <table class="table-auto w-full">
            <thead>
              <tr>
                <th class="border-b border-gray-300 pb-2 text-left text-gray-800 font-medium">
                  ต้นทาง
                </th>
                <th class="border-b border-gray-300 pb-2 text-left text-gray-800 font-medium">
                  ปลายทาง
            ...
            <tbody>
              <tr v-for="bankDatas in bankData" :key="bankDatas.account_transition_id"
                ...
                <td class="flex justify-center items-center p-1">
                  <button v-if="bankDatas.account_transition_id === maxAccountTypeId"
                    class="bg-black flex justify-center items-center text-white w-8 h-8 rounded-full hover:bg-black transition-colors duration-200 ease-in-out"

<template>
  <div class="">
    <div class="mx-auto bg-white overflow-hidden">
      <h2 class="text-2xl font-semibold  p-3  border-b border-gray-200">คืนเงินให้เจ้าหนี้</h2>
      <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-7 gap-6 mb-8">
          <div class="md:col-span-3 space-y-3">
            <h3 class="text-sm md:text-md font-medium text-gray-700 mb-3 flex items-center">
              <span
                class="inline-flex items-center justify-center bg-green-100 w-6 h-6 rounded-full mr-2 text-green-600 text-sm">1</span>
              เลือกบัญชี
            </h3>
                ...
                ">
                  <div class="flex items-center p-1">
                    ...
                    <div class="flex-1 flex justify-between">
                      <p class="font-medium font-medium text-xs md:text-sm">{{ item.account_type_name }}</p>
                      <p :class="[
...
const toggleColumnTwo = (type) => {
  ...
  if (
    ...
    accountTypeValue.value = parseFloat(

<template>
  <div
    class="pt-6 bg-white h-auto overflow-y-auto text-gray-800 p-6 rounded-md"
  >
    <div
            ...
            <div class="flex items-start justify-between mb-4">
              <div class="flex-1">
                <div class="flex items-center mb-2">
                  ...
                  <span
                    class="text-emerald-600 text-sm font-medium uppercase tracking-wide"
                    >กลุ่ม</span
                  >
                </div>

                <h3
                  class="font-bold text-gray-800 text-lg mb-1 group-hover:text-emerald-700 transition-colors"
                >

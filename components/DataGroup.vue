<template>
  <div
    class="pt-6 bg-white h-auto overflow-y-auto text-gray-800 p-2 rounded-md"
  >
    <div
    ...
    <div v-else>
      ...
      <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-1">
        ...
        >
            ...
            <div class="flex items-start justify-between">
              <div class="flex-1">
                <div class="flex items-center mb-2 space-x-2">
                  ...
                  <span
                    class="text-sky-600 text-sm font-medium uppercase tracking-wide"
                    >กลุ่ม</span
                  >
                </div>

                <h3
                  class="font-bold text-gray-800 text-lg mb-1 transition-colors"
                >
          ...
          >
            <div class="flex space-x-2">
              ...
              >
                <svg
                  class="w-2 h-2 md:w-3 md:h-3 inline mr-1"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        >
          ...
          <span class="text-sky-600 font-semibold text-lg mb-1"
            >เพิ่มกลุ่มใหม่</span
          >
...
const deleteFormData = async (account_group_id) => {
  try {
    ...
    if (result.isConfirmed) {
      await $axios.delete(`/account_group_del/${account_group_id}`);

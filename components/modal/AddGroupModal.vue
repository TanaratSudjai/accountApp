                ...
                <form @submit.prevent="submitForm">
                  <div class="mb-4">
                    <label
                      ...
                      class="block text-sm font-medium text-[#46cb79] mb-2"
                      >ชื่อกลุ่ม</label
                    >
                    <input
                      ...
                      type="text"
                      class="w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-black focus:border-[#46cb79] focus:outline-none focus:ring-1 focus:ring-[#46cb79]"
                      placeholder="กรุณากรอกชื่อกลุ่ม"
                    />
                  </div>

                  <div class="mb-4">
                    <label class="block text-sm font-medium text-[#46cb79] mb-2"
                      >ประเภท</label
                    >
                    <div
                      class="bg-white rounded-md border border-gray-200 px-3 py-2 text-gray-300"
                    >
                      <GetgroupName
                        :category-id="formData.account_category_id"
                      />
                    </div>
                  </div>
                  ...
                  <div class="flex justify-end space-x-3 mt-6">
                    <button
                      type="button"
                      @click="$emit('close')"
                      class="rounded-md border bg-gray-400 border-gray-200 px-4 py-2 text-sm font-medium text-white hover:bg-gray-700 transition-colors"
                    >
                      ยกเลิก
                    </button>
                    <button
                      type="submit"
                      class="rounded-md bg-[#46cb79] px-4 py-2 text-sm font-medium text-[#111827] hover:bg-[#3ba962] transition-colors"
                    >
                      บันทึก
                    </button>
                  </div>

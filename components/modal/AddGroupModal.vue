        ...
        <div v-if="show" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
          ...
          <div class="flex min-h-screen items-center justify-center p-4 text-center sm:p-0">
            <Transition name="slide-up">
              <div 
                v-if="show"
                class="relative transform overflow-hidden rounded-lg bg-[#1f2937] text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg border border-gray-700"
              >
                <!-- Modal header -->
                <div class="border-b border-gray-700 px-6 py-4 flex justify-between items-center">
                  <h3 class="text-lg font-medium text-white">เพิ่มกลุ่มบัญชีใหม่</h3>
                  <button 
                    @click="$emit('close')" 
                  ...
                  <form @submit.prevent="submitForm">
                    <div class="mb-4">
                      ...
                      <input 
                        ...
                        type="text" 
                        class="w-full rounded-lg border border-gray-600 bg-[#111827] px-3 py-2 text-white focus:border-[#46cb79] focus:outline-none focus:ring-1 focus:ring-[#46cb79]"
                    ...
                    <div class="mb-4">
                      ...
                      <div class="bg-[#111827] rounded-lg border border-gray-600 px-3 py-2 text-gray-300">
                    ...
                    <div class="flex justify-end space-x-3 mt-6">
                      <button
                        type="button"
                        @click="$emit('close')"
                        class="rounded-lg border border-gray-600 bg-transparent px-4 py-2 text-sm font-medium text-white hover:bg-gray-700 transition-colors"
                      >
                        ยกเลิก
                      </button>
                      <button
